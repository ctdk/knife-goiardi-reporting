...
require 'chef/goiardi/reporting/knife_helpers'

class Chef
  class Knife
    class GoiardiRunsList < Chef::Knife
      ...
      include Chef::Goiardi::Reporting::KnifeHelpers

      banner "knife goiardi runs list [<node name>]"
      ...
      option :status,
        ...
        :short => '-S N',
        :required => false,
        :description => "Only return reports matching the given status. Acceptable status are 'started', 'success', and 'failure'."
